...
**Tech:** Claude Sonnet 4.5, LangGraph, E2B Sandbox, Hybrid Search (BM25 + Semantic)
...
**Tech:** FastAPI, XGBoost, MLflow, Prometheus, Grafana, Docker
...
**Tech:** DistilBERT, Qdrant (Vector DB), Redis, Streamlit
...
- [Portfolio](https://ayushmalik.dev)
- [LinkedIn](https://linkedin.com/in/ayush67)
- [Email](mailto:ayushkumarmalik10@gmail.com)
